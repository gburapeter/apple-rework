...
export default function Index() {
	...
	return (
		<>
			...
			<Section className="bg-[radial-gradient(ellipse_at_top_left,_var(--tw-gradient-stops))] from-black via-blue-800 to-black grid !h-min pt-[13vh] place-items-center ">
				<Cardgang />
			</Section>
			...
			<Section className="!min-h-[calc(100vh/1.3)]  grid place-items-center ">
				<div className=" xl:px-20 lg:px-12 sm:px-6 px-4 py-12">
					<div className="flex flex-col items-center justify-center">
						<div>
							<h1 className="text-5xl pb-[10vh] text-white">Apple</h1>
						</div>
						...
						<div className="flex items-center mt-6">
							<p className="text-base leading-4 ">
								<span className="font-semibold">2023 Apple Inc.</span>
							</p>
