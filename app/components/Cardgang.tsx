...
export default function Cardgang() {
	return (
		<div className="cursor-pointer max-w-screen gap-2 grid grid-cols-12 grid-rows-3 p-12">
			...
			<Card
				isFooterBlurred
				className="xl:row-span-2 2xl:row-span-2 border-4 border-transparent hover:border-slate-100 transition ease-in-out delay-150 w-full h-[300px] col-span-12 sm:col-span-5"
			>
				<CardHeader className="absolute z-10 top-1 flex-col items-start">
			...
			<Card
				isFooterBlurred
				className="xl:row-span-2 2xl:row-span-2 border-4 border-transparent hover:border-slate-100 transition ease-in-out delay-150 w-full h-[300px] col-span-12 sm:col-span-7"
			>
				<Image
					removeWrapper
